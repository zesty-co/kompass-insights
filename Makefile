...
lint: ## Lint Helm chart
	...
	@helm template test-release ./charts/zesty --values charts/zesty/values.yaml --values hack/kubeconform-extras.yaml | kubeconform -strict -summary --ignore-missing-schemas
